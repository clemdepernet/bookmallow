...
(() => {
  ...
  const I18N = {
    fr: {
      tagline: "Ton compagnon de livres audio",
      hero_title: "Un lien YouTube, un livre audio",
      hero_lead: "Colle le lien d'une lecture, d'une conférence ou d'un livre lu sur YouTube : Bookmallow en fait un MP3 léger, prêt pour ton téléphone.",
      ...
      queue: "En cours",
      queue_empty: "Rien en cours pour l'instant. Cherche un livre ou importe un lien.",
      library: "Ta bibliothèque",
      library_empty: "Ta bibliothèque est encore vide.",
      banner: "Bookmallow garde tes {n} derniers livres. Télécharge-les sur ton téléphone pour les garder.",
      banner_one: "Bookmallow ne garde qu'un livre à la fois. Télécharge-le dès qu'il est prêt.",
      ...
      tab_convert: "Importer depuis YouTube",
      tab_store: "Trouver un livre",
      store_title: "Trouve ton prochain livre",
      store_lead: "Un titre, un auteur, une envie : des milliers de livres audio libres en français et en anglais, et tes propres sources si tu les as branchées.",
      ...
      store_none: "Aucun livre avec ces mots. Essaie l'auteur seul, ou l'autre langue.",
      store_add: "Ajouter à ma bibliothèque",
      store_added: "Livre ajouté, il arrive dans ta bibliothèque",
      store_free: "Libre",
    ...
    en: {
      tagline: "Your audiobook companion",
      hero_title: "A YouTube link, an audiobook",
      hero_lead: "Paste the link of a reading, a lecture or a narrated book on YouTube: Bookmallow turns it into a light MP3 for your phone.",
      ...
      queue: "In progress",
      queue_empty: "Nothing in progress yet. Find a book or import a link.",
      library: "Your library",
      library_empty: "Your library is still empty.",
      banner: "Bookmallow keeps your {n} most recent books. Download them to your phone to keep them.",
      banner_one: "Bookmallow keeps one book at a time. Download it as soon as it is ready.",
      ...
      tab_convert: "Import from YouTube",
      tab_store: "Find a book",
      store_title: "Find your next book",
      store_lead: "A title, an author, a mood: thousands of free audiobooks in French and English, plus your own sources when they are connected.",
      ...
      store_none: "No book with those words. Try the author alone, or the other language.",
      store_add: "Add to my library",
      store_added: "Book added, it is on its way to your library",
      store_free: "Free",
      store_torrent: "Torrent",
  ...
  const state = {
    ...
    tab: store.get("bookmallow.tab") || (body.dataset.storeEnabled === "1" ? "store" : "convert"),
